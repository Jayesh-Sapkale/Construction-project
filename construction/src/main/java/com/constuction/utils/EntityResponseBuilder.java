...
public class EntityResponseBuilder {
	...
	public CreateUserResponseDto convertUserEntityToDto(Long id) throws ConstructionException {
		Users savedUser = userRepository.findById(id).orElseThrow(() -> new ConstructionException("User not found for id: " + id));
